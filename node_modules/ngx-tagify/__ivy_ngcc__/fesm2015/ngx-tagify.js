...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TagifyService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
TagifyComponent.ɵfac = function TagifyComponent_Factory(t) { return new (t || TagifyComponent)(ɵngcc0.ɵɵdirectiveInject(TagifyService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
TagifyComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TagifyComponent, selectors: [["tagify"]], viewQuery: function TagifyComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(_c0, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.inputRef = _t.first);
    } }, inputs: { settings: "settings", name: "name", inputClass: "inputClass", readonly: "readonly", whitelist: "whitelist" }, outputs: { add: "add", remove: "remove", tInput: "tInput" }, features: [ɵngcc0.ɵɵProvidersFeature([{
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => TagifyComponent),
                multi: true
            }])], ngContentSelectors: _c1, decls: 4, vars: 1, consts: [[3, "ngClass"], ["inputRef", ""], [2, "display", "none"]], template: function TagifyComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵproperty("ngClass", ctx.inputClassValue);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TagifyComponent, [{
        type: Component,
        args: [{
                selector: 'tagify',
    ...
    }], function () { return [{ type: TagifyService }, { type: ɵngcc0.ElementRef }]; }, { settings: [{
            type: Input
        }], name: [{
            type: Input
        }], add: [{
...
TagifyModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: TagifyModule });
TagifyModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function TagifyModule_Factory(t) { return new (t || TagifyModule)(); }, providers: [TagifyService], imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TagifyModule, { declarations: function () { return [TagifyComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [TagifyComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TagifyModule, [{
        type: NgModule,
        args: [{
